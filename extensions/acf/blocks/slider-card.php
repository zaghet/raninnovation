...
add_action('acf/init', function() {
    \TST\ACF::register_block('slider-card', array(
        'title'             => __('Slider Card'),
        'description'       => __('A slider card block.'),
        'icon' 				=> '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-postcard" viewBox="0 0 16 16">
